...
public static class LanguageSource
{
    ...
    private static Dictionary<string, string[]> language_string_dict = new Dictionary<string, string[]>()
    {
        ...
        { "store cue recall", new string[] {"Please recall which item you delivered to the store shown on the screen.", "Bitte nennen Sie den Gegenstand, den Sie zu dem gezeigte Geschäft geliefert haben."} },
        ...
        { "cued recall message", new string [] { "Press the (X) key after recalling the item to move to the next store", "Drücken Sie (X), nachdem Sie den Namen des gelieferten Gegenstands ausgesprochen haben, um zum nächsten Geschäft zu gelangen." } },
        { "cued recall title", new string [] { "Cued Recall", "Abruf des zu einem Geschäft gelieferten Gegenstands"} },
        { "online cued recall main", new string [] {"Please recall which item you delivered to the store shown on the screen.\n\nPress the Enter key after recalling the item to move to the next store", "Bitte erinnern Sie sich, welchen Gegenstand Sie zu dem auf dem Bildschirm angezeigten Geschäft geliefert haben.\n\nDrücken Sie die Eingabetaste, nachdem Sie den Namen des Gegenstands eingegeben haben, um zum nächsten Geschäft zu gelangen.”}},
